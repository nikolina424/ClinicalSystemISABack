...
insert into users (first_name, last_name, email, password, address, city, country, phone_number, user_id, role, enabled, first_time_logged, predefined) values ('Stefan', 'Pejakovic', 'spejakovic4@gmail.com', '$2a$10$LUg80LWtePrHM/Oba6pJHu0BKXjgCA4GcbeTB6TD4Yos3APqstUCy', 'XVI Divizija 137', 'Kula', 'Srbija', 0613729356, 0208997, 'ADMINCC', true, true, true);
